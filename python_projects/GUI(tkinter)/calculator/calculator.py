...
sub_button = Button(root, text = "-", padx=40, pady=20, command= button_sub)
multi_button = Button(root, text = "*", padx=40, pady=20, command= button_mult)
...
all_clear_button = Button(root, text = "C", padx=40, pady=20, command = button_clear)
